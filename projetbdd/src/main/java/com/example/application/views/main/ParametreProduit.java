...
public class ParametreProduit extends HorizontalLayout{
    ...
    public ParametreProduit(GroupeProduit gp)throws SQLException{
        ...
        this.ajoutOperation = new HorizontalLayout(operationExistante,creerOperation);
        ...
        this.gamme.setItems(Gamme.listerGamme(this.gpProduit.getGestionnaire().getConnection()));
